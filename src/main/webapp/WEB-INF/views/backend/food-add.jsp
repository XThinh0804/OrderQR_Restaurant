            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h2 class="page-title text-truncate text-dark font-weight-medium mb-1">Thêm món ăn</h2>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
			...
			<div class="container-fluid">
                ...
                <div class="row">
                	<div class="col-12">
	                    <div class="card">
	                        <div class="card-body">
	                        	<sf:form class="form" action="${resource }/admin/food/add-save" method="post" modelAttribute="food" enctype="multipart/form-data">
	                        			...
	                        			<div class="row">
	                        		 		...
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="name" type="text" class="form-control" id="name" name="name" placeholder="food name"></sf:input>
                                        		</div>
	                                    	</div>
										</div>
