				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							<div class="card-body">
								<form action="${resource}/admin/order/detail/${orderId}" method="get">
									<div class="table-responsive">
										<table id="zero_config"
											...
											<tbody>
												<c:forEach var="orderFood" items="${orderFoods}" varStatus="loop">
													<tr>
														<th scope="row" class="text-center">${loop.index + 1}</th>
														<td align="center">${orderFood.name }</td>
														<td align="center"><fmt:formatNumber
																value="${orderFood.food.price }" minFractionDigits="0"></fmt:formatNumber>
															<span>vnđ</span></td>

														<td align="center"><img width="90px" height="80px"
															src="${resource}/UploadFiles/${orderFood.food.image}"
															class="light-logo"></td>
														<td align="center">${orderFood.quantity }</td>
													</tr>
												</c:forEach>
											</tbody>
											<tfoot>
